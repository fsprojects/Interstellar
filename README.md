...
- [Interstellar.Wpf.WebView2](https://www.nuget.org/packages/Interstellar.Wpf.WebView2/)
  - Implements Interstellar on Windows for WPF using the native system WebView2 (Chromium Edge). The [WebView2 runtime](https://developer.microsoft.com/en-us/microsoft-edge/webview2/) must be already installed on the end system in order for this package to work, otherwise a ``Interstellar.BrowserInitializationException`` will be thrown at runtime.
